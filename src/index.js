...
function createComputerShips(computer) {
    ...
    callFunctionUntilTrue(board.placeShip(Ship(5), generateRandomNumber(5), getRandomBoolean()));
    callFunctionUntilTrue(board.placeShip(Ship(4), generateRandomNumber(4), getRandomBoolean()));
    callFunctionUntilTrue(board.placeShip(Ship(3), generateRandomNumber(3), getRandomBoolean()));
    callFunctionUntilTrue(board.placeShip(Ship(3), generateRandomNumber(3), getRandomBoolean()));
    callFunctionUntilTrue(board.placeShip(Ship(2), generateRandomNumber(2), getRandomBoolean()));
}
